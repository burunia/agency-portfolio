      ...
      <main className="flex-1">
        <article className="container mx-auto px-4 py-16">
          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6 font-vidaloka">Understanding Your Camera</h2>
            ...
            <h3 className="text-2xl font-bold mt-8 mb-4 font-vidaloka">Key Camera Settings</h3>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6 font-vidaloka">Composition Techniques</h2>
            <p className="font-roboto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="font-bold mb-2 font-vidaloka">Rule of Thirds</h4>
                <p className="text-gray-600 font-roboto">
                  Divide your frame into nine equal parts and place key elements along these lines or at their intersections.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="font-bold mb-2 font-vidaloka">Leading Lines</h4>
                <p className="text-gray-600 font-roboto">
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6 font-vidaloka">Lighting Fundamentals</h2>
            <p className="font-roboto">
            ...
            <blockquote className="border-l-4 border-[#d4b88e] pl-4 my-8 italic font-roboto">
              "Photography is the art of capturing light. Master the light, and you'll master the art."
            </blockquote>

            <h2 className="text-3xl font-bold mt-12 mb-6 font-vidaloka">Post-Processing Basics</h2>
            <p className="font-roboto">
            ...
            <h2 className="text-3xl font-bold mt-12 mb-6 font-vidaloka">Conclusion</h2>
            <p className="font-roboto">
